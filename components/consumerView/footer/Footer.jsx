...
export default function Footer() {
  return (
    <footer className="bg-cobalt mt-auto text-white p-2 w-full border border-b-0 border-l-0 border-r-0 border-t-2 border-bluebell absolute bottom-0 h-[440px] md:h-[250px]">
